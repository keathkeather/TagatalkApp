...
const EditProfile = () => {
  ...
  const maxLength = 100; //*Max length of the bio here
       ...
       behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
        ...
        <ScrollView>
          <View style={styles.headerContainer}>
            ...
            <Image
              source={image ? { uri: image } : icons.defaultProfile}
              style={styles.profileImage}
            />
            </View>
            <TouchableOpacity 
              onPress={pickImage}
              style={{position: 'absolute',  right: 100, top: 170, zIndex: 9999}}>
              <Image
                source={icons.camera}
                style={{
                  height: 40,
            ...
            <View style={styles.formContainer}>
                ...
                <TextInput style={styles.textInput} placeholder='Current Username ni sha dapat'/>
